  ...
  return (
    <main className="dd-legal" style={{ minHeight: "100vh", background: "#F7F4EE", color: "#221611", padding: "48px 20px", fontFamily: "Albert Sans, system-ui, sans-serif" }}>
      <article style={{ maxWidth: 760, margin: "0 auto", background: "#fff", border: "1px solid #E6DFD3", padding: "clamp(28px,6vw,64px)" }}>
        ...
        <h2>Passport on this device</h2><p>The guest Passport preview can store non-contact preferences—such as taste choices, brewer type and saved catalogue identifiers—in your browser&apos;s local storage. It also stores saved Brewprints, brew notes, reading bookmarks and public request references. Contact details and private tracking tokens are not automatically saved in browser storage. A private receipt or an unsent request can be downloaded only when you choose to download it. Keep downloaded files private. You can clear it using your browser&apos;s site-data controls.</p>
        ...
        <p style={{ marginTop: 34, paddingTop: 20, borderTop: "1px solid #E6DFD3", color: "#7A6A5C", fontSize: 13 }}>Last updated 10 September 2026 · This notice describes the current platform build and must be replaced or approved by Deldiet before commercial launch.</p>
      </article>
    </main>
  );
}
